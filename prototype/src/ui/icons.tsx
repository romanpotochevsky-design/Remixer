...
/**
 * The kit's `calendar_month`, solid — the 20px mark in the Analytics header's range select
 * (Figma 30934:94544). Material geometry on the 24 grid, like `Add` and `search` beside it.
 */
export const IconCalendarM = ({ size = 24, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
