...
1. **Превью раскрывается само, когда начинается билд.** У Lovable дизайнер нажал ⤢ вручную; что было бы
   без нажатия — неизвестно. У нас свечение по кромке превью — единственный индикатор работы, схлопнутое
   превью оставило бы билд без сигнала. Одна константа, если решим иначе.
2. **Тайминги сжаты для демо:** 2,6 с «думает» вместо 15–21 с, 1,4 с до «Got it», 4,2 с билд.
3. **Правый рейл остаётся** (он в нашей Figma); у Lovable рейла нет, поэтому их иконка ⤢ у самого края окна,
   наша — в стеклянной группе шапки чата.
4. **Ширина чата в сплите — 432 (Figma), не 600.** Центрирование на 600 включается только когда колонка
   шире 600, то есть в схлопнутом режиме.
5. **Копирайт** — фразы Lovable дословно, с заменой имени продукта; вопросы те же. Это стартовая точка,
   а не финальные тексты Remixer.
6. Шрифты в карточках типографики: реальные Space Grotesk/Instrument Serif/DM Serif в прототип не зашиты,
   рендерятся подмены (Outfit/Figtree/системные).
