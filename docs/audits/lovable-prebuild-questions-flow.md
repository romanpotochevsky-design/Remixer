...
9. **Копирайт вопросов** — пока фразы Lovable дословно, с заменой имени продукта.
   Финальные тексты Remixer за дизайнером. Нарисованный на борде вопрос
   «Show 3 Luxury First Class design options…» в бриф НЕ добавлен: он обещает шаг
   с тремя визуальными направлениями, которого у нас нет.
10. Шрифты в карточках типографики: реальные Space Grotesk/Instrument Serif/DM Serif
   в прототип не зашиты. В новой форме это уже не так заметно — гарнитуры называются
   в строке последствия текстом, а не показываются образцом.
