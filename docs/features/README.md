...
|---|---|---|
| **Analytics** | окно аналитики: пять метрик над недельным графиком и четыре разбивки — страна · источник · устройство · страница (Figma 30934:93319); зелёный акцент рейла вместо прежнего янтарного | [`analytics/README.md`](analytics/README.md) |
...
- **Style / Extension** — иконки в правом рейле уже есть, содержимого нет (у **Cloud**
  с 22.09.2026 и у **Analytics** с 24.09.2026 есть свои окна — см. фича-базы выше).
