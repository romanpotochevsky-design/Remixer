...
> `securing` (базовый вариант есть, «застряло» нет) и `in-use-here` (гард есть, но с одним
> вариантом). По разбору 17 продуктов это примерно 40% реального трафика. Все тринадцать
...
1, 2, 3 и 4 каталога, которые живут здесь (`OPEN-QUESTIONS.md` 03); `connect.md` §12.3
